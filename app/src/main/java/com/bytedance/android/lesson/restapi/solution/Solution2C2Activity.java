...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> postCall = retrofit
                .create(IMiniDouyinService.class)
                .createVideo("1120172176", "陆俊奇",
        ...
        postCall.enqueue(new Callback<PostVideoResponse>() {
            ...
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                Toast.makeText(getApplicationContext(), R.string.success_try_refresh, Toast.LENGTH_SHORT).show();
                mBtn.setText(R.string.select_an_image);
    ...
    public void fetchFeed(View view) {
        ...
        Retrofit retrofit = RetrofitManager.get(IMiniDouyinService.HOST);
        Call<FeedResponse> feedResponseCall = retrofit
                .create(IMiniDouyinService.class)
                .getFeed();
